...
Lets visualize the data to see Below we plot a regression line (mpg against weight) and indicate the transmission types in different colours.  
It seems that heavier cars tend to have automatic transmission, while lighter cars tend to have manual transmission.  The data set has a range between 2.5lb and 3.5lb where both manual and automatic transmission samples are available.  In this range, the automatic cars tend to have a higher mpg.

==> diferent slopes for blue and red ==> weight affects automatic cars less
...
# Residual analysis
Lets review the residuals of our model, to check for signs of temporal patterns, heteroskedasticity and non-normality.
